...
resourcename="airportmanagement"  # lower case, only
resourcegroup="airportmanagement_rg"
...
# git clone https://github.com/apilogicserver/airportmanagement.git
...
az group create --name airportmanagement_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group airportmanagement_rg --sku S1 --is-linux
az container create --resource-group airportmanagement_rg --name airportmanagement --image apilogicserver/airportmanagement:latest --dns-name-label airportmanagement --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//airportmanagement.westus.azurecontainer.io:5656'
