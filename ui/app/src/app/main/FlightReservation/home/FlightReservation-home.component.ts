...
@Component({
  selector: 'FlightReservation-home',
  templateUrl: './FlightReservation-home.component.html',
  styleUrls: ['./FlightReservation-home.component.scss']
})
export class FlightReservationHomeComponent implements AfterViewInit {
