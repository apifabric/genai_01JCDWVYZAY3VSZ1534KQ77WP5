...
@Component({
  selector: 'Runway-home',
  templateUrl: './Runway-home.component.html',
  styleUrls: ['./Runway-home.component.scss']
})
export class RunwayHomeComponent implements AfterViewInit {
