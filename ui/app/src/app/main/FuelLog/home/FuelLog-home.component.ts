...
@Component({
  selector: 'FuelLog-home',
  templateUrl: './FuelLog-home.component.html',
  styleUrls: ['./FuelLog-home.component.scss']
})
export class FuelLogHomeComponent implements AfterViewInit {
