...
@Component({
  selector: 'Hangar-home',
  templateUrl: './Hangar-home.component.html',
  styleUrls: ['./Hangar-home.component.scss']
})
export class HangarHomeComponent implements AfterViewInit {
