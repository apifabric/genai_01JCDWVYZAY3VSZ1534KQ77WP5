...
@Component({
  selector: 'BaggageClaim-home',
  templateUrl: './BaggageClaim-home.component.html',
  styleUrls: ['./BaggageClaim-home.component.scss']
})
export class BaggageClaimHomeComponent implements AfterViewInit {
