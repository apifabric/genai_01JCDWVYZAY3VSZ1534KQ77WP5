...
@Component({
  selector: 'Aircraft-home',
  templateUrl: './Aircraft-home.component.html',
  styleUrls: ['./Aircraft-home.component.scss']
})
export class AircraftHomeComponent implements AfterViewInit {
